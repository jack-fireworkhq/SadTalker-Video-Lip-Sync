...
from sadtalker_video_lip_sync.src.facerender.animate import AnimateFromCoeff
from sadtalker_video_lip_sync.src.generate_batch import get_data
from sadtalker_video_lip_sync.src.generate_facerender_batch import get_facerender_data
from sadtalker_video_lip_sync.src.test_audio2coeff import Audio2Coeff
from sadtalker_video_lip_sync.src.utils.preprocess import CropAndExtract
from sadtalker_video_lip_sync.third_part.GFPGAN.gfpgan import GFPGANer
from sadtalker_video_lip_sync.third_part.GPEN.gpen_face_enhancer import FaceEnhancement
...
if __name__ == '__main__':
    ...
    parser.add_argument("--checkpoint_dir", help="path to output")
    parser.add_argument("--result_dir",  help="path to output")
    ...
    parser.add_argument('-h', '--help', dest="help", action='help',
                        help='Please provide driven_audio, source_video, checkpoint_dir and result_dir.')

    args = parser.parse_args()
    if args.help:
        print("Please provide driven_audio, source_video, checkpoint_dir and result_dir.")
        exit(0)
